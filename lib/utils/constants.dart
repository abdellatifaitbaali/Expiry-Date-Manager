...
class AppConstants {
  ...
  static const String websiteUrl = 'https://nexodev.site/';
  static const String contactEmail = 'contact@nexodev.site';
  static const String privacyPolicyUrl = 'https://nexodev.site/privacy-policy';
  static const String termsOfServiceUrl = 'https://nexodev.site/terms-of-service';
